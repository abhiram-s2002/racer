// Supabase Edge Function: send-fcm-simple
// Sends undelivered notifications via FCM V1 API using a simplified approach
// This version uses the Firebase Admin SDK approach but simplified for Edge Functions
...
async function getAccessToken(): Promise<string> {
  ...
  // For now, we'll use a workaround by calling Google's token endpoint
  // In production, you'd properly sign this with the private key
