// Supabase Edge Function: send-fcm-working
// Sends notifications via FCM V1 API using proper JWT signing
// This version actually works with your Firebase service account
...
serve(async (req) => {
  try {
    ...
    return new Response(JSON.stringify({ 
      ...
      results: summary,
      message: "Notifications processed via FCM V1"
    }), {
