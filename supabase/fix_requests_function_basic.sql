-- Ultra-simple get_requests_hierarchical function
-- This version only uses basic columns that definitely exist
...
-- Test the function
SELECT 'Basic function created successfully' as status;
