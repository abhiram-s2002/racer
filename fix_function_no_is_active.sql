-- ============================================================================
-- FIX LISTINGS FUNCTION WITHOUT is_active FIELD
-- ============================================================================
-- This script creates the get_listings_with_distance function without using is_active

-- Drop existing function to avoid conflicts
DROP FUNCTION IF EXISTS get_listings_with_distance(double precision, double precision, integer, text, integer);

-- Create the main listings function WITHOUT is_active field
...
BEGIN
    ...
    SELECT 
        ...
        l.created_at
    FROM listings l
    WHERE l.expires_at > NOW()  -- Only non-expired listings (no is_active check)
